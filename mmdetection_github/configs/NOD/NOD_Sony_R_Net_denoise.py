...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        frozen_stages=-1,
        norm_cfg=dict(type='GN', num_groups=32, requires_grad=False),
        norm_eval=True,
        style='pytorch',
        model="our",
        ISP_version='v2',
...
test_pipeline = [
    ...
    dict(
        ...
        bayer_substitute = '/guojs/data/NOD/Sony_RGB/'
        )
]
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'backbone.ISP': dict(lr_mult=1.0),  # 1.0
        }
    ))
