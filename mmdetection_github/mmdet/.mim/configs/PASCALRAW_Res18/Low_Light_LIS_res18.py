...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=10),
    noise_optpath='mmdetection_github/mmdet/models/detectors/noise_utils/noise_g_virtual.yaml')


dataset_type = 'PASCAL_RAWDataset'
# dataset_type = 'PASCAL_RAW'
data_root = '/public/home/guojs/data/PASCAL_RAW/PASCALRAW/'
