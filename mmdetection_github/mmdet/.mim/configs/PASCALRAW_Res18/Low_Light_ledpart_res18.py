...
dataset_type = 'PASCAL_RAWDataset'
data_root = '/public/home/guojs/data/PASCAL_RAW/PASCAL_RAW_github/'


backend_args = None

train_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, postfix='npz'),
    dict(type='LoadAnnotations', with_bbox=True),
    dict(type='Resize', scale=(667, 400), keep_ratio=True),
    dict(type='RandomFlip', prob=0.5),
    dict(type='PackDetInputs',
         meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
                    'scale_factor', 'flip', 'flip_direction', 'wb',
                    'ccm'   ))
]
        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    ...
                    img_subdir = 'demosaic_low_patches',
